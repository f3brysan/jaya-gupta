                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-left">
                                <a href="{{ URL::to('data-peserta-didik/export-template') }}" class="btn btn-primary mb-3"
                                ...
                                <a href="javascript:void(0)" class="btn btn-info mb-3" onclick="importExcel()"><i
                                        class="fa fa-upload"></i> Unggah Data</a>
                                {{-- <a href="javascript:void(0)" class="btn btn-primary mb-3" onclick="importExcel()"> Tambah</a> --}}
                            </div>
