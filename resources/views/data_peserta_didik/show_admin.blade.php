                                ...
                                <tbody>    
                                    ...
                                    @foreach ($data_pd as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ URL::to('admin/data-peserta-didik/detail/'.$item->npsn) }}">{{ $item->nama }}</a></td>
                                            <td>{{ $item->npsn }}</td>
                                            <td>{{ $item->bentuk_pendidikan }}</td>
                                            <td>{{ $item->status_sekolah }}</td>
                                            <td class="text-right">{{ $item->tot_l }} @php
                                                $total_l += $item->tot_l;
                                            @endphp</td>
                                            <td class="text-right">{{ $item->tot_p }} @php
                                                $total_p += $item->tot_p;
                                            @endphp</td>
                                            <td class="text-right">{{ $item->tot_l + $item->tot_p }} @php
                                            $total_lp += $item->tot_l + $item->tot_p
                                            @endphp</td>
                                        </tr>
                                    @endforeach                                
                                </tbody>
