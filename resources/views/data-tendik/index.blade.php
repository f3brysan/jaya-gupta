                    ...
                    <div class="card">
                        <div class="col-md-12">
                            <div class="float-left">
                                ...
                                <a href="{{ URL::to('data-tendik/export-template') }}" class="btn btn-primary mb-3"
                                ...
                                <table id="example" class="table table-bordered table-hover table-bordered"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tendik Penggerak</th>
                                            <th class="text-center">Tugas Tambahan</th>
                                        ...
                                        @foreach ($getData as $dt)
                                            <tr>
                                                <td class="text-center">
                                                    <a href="{{ URL::to('data-tendik/ubah/' . $dt->id) }}"
                                                        target="_blank" title="Ubah Data" class="btn btn-sm btn-info m-1"><i
                                                            class="fa fa-edit"></i></a>
                                                    <form action="{{ URL::to('data-tendik/hapus') }}"
                                                        method="POST">
                                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ URL::to('data-tendik/import') }}" method="post"
