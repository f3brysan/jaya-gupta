                                    ...
                                    <table id="example" class="table table-bordered table-hover table-bordered"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Nama Matpel</th>
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="jam_pelajaran" name="jam_pelajaran" required>
                        </div>   
                        <div class="form-group">
                            <label>Jenjang</label>
                            <select class="form-control" name="jenjang" id="jenjang" required>
                                ...
                                @foreach ($jenjang as $item)
                                    <option value="{{ $item->bentuk_pendidikan }}">{{ $item->bentuk_pendidikan }}</option>
                                @endforeach
                            </select>                            
                        </div>            
                </div>
    ...
    <script>
        ...
        $("body").on("click", ".edit", function() {
            ...
            $.get("{{ URL::to('master/mata-pelajaran/edit') }}/" + data_id, function(data) {
                ...
                $("#id").val(data.id);
                $("#nama").val(data.nama);
                $("#jam_pelajaran").val(data.jam_pelajaran);
