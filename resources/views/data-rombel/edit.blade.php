...
@section('title', 'Ubah Rombongan Belajar')
@push('css-custom')
    <!-- CSS Libraries -->
                            ...
                            <form action="{{ URL::to('data-rombel/simpan') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select name="nama_rombel" class="form-select form-control" id="">
                                            ...
                                            <option value="{{ $item->rombel }}" {{ $item->rombel == $rombel->nama_rombel ? 'selected' : '' }}>{{ Str::upper($item->rombel) }}</option>
                                            @endforeach
                                        </select>      
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="tingkat_kelas" value="{{ $rombel->tingkat_kelas }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select name="wali_kelas" id="" class="form-control select2">
                                            ...
                                            @foreach ($guru as $item)
                                                <option value="{{ $item->bio->nuptk }}" {{ $rombel->wali_kelas == $item->bio->nuptk ? 'selected' : ''}}>{{ $item->bio->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>Ruangan</label>
                                        <input type="text" class="form-control" name="ruangan" value="{{ $rombel->ruangan }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>Kurikulum</label>
                                        <input type="text" class="form-control" name="kurikulum" value="{{ $rombel->kurikulum }}">
                                    </div>
                                </div>
