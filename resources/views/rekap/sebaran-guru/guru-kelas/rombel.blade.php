...
@section('title', 'Rekapitulasi Sebaran Rombel Guru Kelas'.$bentuk_pendidikan.' '.$status_sekolah)
@push('css-custom')
    <!-- CSS Libraries -->
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Rekapitulasi Sebaran Rombel {{ $bentuk_pendidikan }} {{ $status_sekolah }}</h1>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $item->tot_rombel }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                    <tfoot>
                                        <tr>                                        
                                            ...
                                            <th class="text-center">{{ $total_rombel }}</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
