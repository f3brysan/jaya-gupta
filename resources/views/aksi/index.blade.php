                                ...
                                <tbody>
                                    @foreach ($aksi as $item)
                                        <tr>
                                            ...
                                            <td align="center"> <img src="{{ URL::to('/') }}/{{ $item->image }}" style="width: 80px"
                                            ...
                                            <td align="center">@if ($item->nilai == NULL)
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-info m-1" title="Lihat Data" data-toggle="modal" data-target="#modal{{ $item->id }}"><i class="far fa-eye"></i></a>
                                               @php
                                               ...
                                               @endphp
                                                <a href="{{ URL::to('guru/aksi-nyata/edit').'/'.$encryptUrl }}" class="btn btn-primary m-1 {{ $disabled }}" title="Edit Data"><i class="fas fa-edit"></i></a>
                                            <form action="{{ URL::to('guru/aksi-nyata/hapus') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="id" id="id" value="{{ $encryptUrl }}">
                                                <button type="submit" class="btn btn-danger m-1 hapus-btn" {{ $disabled }} title="Hapus Data"><i class="fas fa-trash-alt"></i></button>
                                            </form>
                                                </td>
                                                  </div>
            ...
            <div class="modal-body">
              <table class="table">
                ...
                <tr>
                    ...
                    <td valign="top"><img src="{{ URL::to('/') }}/{{ $item->image }}" alt="" class="img-fluid img-thumbnail" style="height: 100px"></td>
                </tr>
              </table>
            </div>
